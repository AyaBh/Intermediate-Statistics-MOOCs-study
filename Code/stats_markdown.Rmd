...
usages_effec1_df <- read_csv("usages.effec1.csv")
usages_effec2_df <- read_csv("usages.effec2.csv")
usages_effec3_df <- read_csv("usages.effec3.csv")
```
```{r}
...
full_df_subset = na.omit(full_df[c('Gender','HDI','n.videos','CSP','age.group')])
...
- do the same for gender and type of learners
